...
export const environmentMap = {
    ...
    map_house_marker_layer: "https://api.geoapify.com/v2/icon/?type=awesome&color=%230573d2&size=42&icon=house&contentSize=15&noWhiteCircle&" + environment.apiKeyParam + environment.geoapifyAPIKey,
