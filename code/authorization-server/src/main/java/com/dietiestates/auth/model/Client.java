...
public class Client {
    ...
    // JSON di settings/token settings -> TEXT/LONGVARCHAR (NO @Lob)
    ...
    public void setClientAuthenticationMethods(String v) { this.clientAuthenticationMethods = v; }

    public String getAuthorizationGrantTypes() { return authorizationGrantTypes; }
    public void setAuthorizationGrantTypes(String v) { this.authorizationGrantTypes = v; }
    ...
    public void setPostLogoutRedirectUris(String v) { this.postLogoutRedirectUris = v; }
