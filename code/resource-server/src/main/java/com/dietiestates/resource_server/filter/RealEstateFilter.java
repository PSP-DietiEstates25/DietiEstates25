...
public interface RealEstateFilter {
    ...
    List<RealEstate> filterRealEstateByGeographicalPosition(
            GeographicalPosition geographicalPosition,
            List<RealEstate> realEstatesToFilter
    );

    List<RealEstate> filterRealEstateByUtility(
            Utility utility,
            List<RealEstate> realEstatesToFilter
    );

    List<RealEstate> filterRealEstateByCadastralFilters(
