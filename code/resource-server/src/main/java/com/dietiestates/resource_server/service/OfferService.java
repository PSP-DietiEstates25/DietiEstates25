...
public interface OfferService {
    ...
    Page<OfferResponse> getOffers(String creatorEmail, String creatorRole, Integer page, Integer size);
    Page<OfferResponse> getAllUserOffers(String userEmail, Integer page, Integer size);
    Page<OfferResponse> getAllEstateAgentOffers(String estateAgentEmail, Integer page, Integer size);
